export const HERO_IMAGE = "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/files/58f8e18c-3a1d-4321-a0d0-d558c40958c4.jpg";
...
export const VEGETABLES = [
  ...
  { id: 12, name: "Помидор Парадайз", price: 220, unit: "кг", season: "лето", type: "томаты", emoji: "🍅", badge: null, weight: "1кг", weightKg: 1, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/files/05cd7a84-8e00-40ff-9e35-a9a9ae50e85f.jpg" },
...
export const VEG_TYPES = ["все", "картофель", "капуста", "корнеплоды", "лук", "томаты", "огурцы", "чеснок"];
...
export const FRUITS = [
  ...
  { id: 127, name: "Имбирь", price: 500, unit: "кг", season: "всесезонно", type: "специи", emoji: "🫚", badge: null, weight: "100г", weightKg: 0.1, minWeightG: 100, pricePerKg: 500, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/2c08ce38-ff3e-4c01-a5fc-68d5d20b8f2f.jpg" },
];
export const FRUIT_TYPES = ["все", "яблоки", "груши", "цитрусы", "сливы", "виноград", "экзотика", "специи"];

export const BERRIES = [
  { id: 201, name: "Клубника", price: 380, unit: "кг", season: "лето", type: "ягоды", emoji: "🍓", badge: null, weight: "1кг", weightKg: 1, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/ea3cfdfd-5e66-4b51-9a4b-2cbf2b3c91e5.jpg" },
  { id: 202, name: "Арбуз", price: 100, unit: "кг", season: "лето", type: "ягоды", emoji: "🍉", badge: null, weight: "1кг", weightKg: 1, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/a2ab5e29-a4f2-4b6f-aad0-66d5d5b5b9a9.jpg" },
];
export const BERRY_TYPES = ["все", "ягоды"];
...
export const JUICE_TYPES = ["все", "напитки", "вода"];
...
export const MUSHROOM_TYPES = ["все", "грибы"];

export const GREENS = [
  { id: 501, name: "Лук зелёный", price: 100, unit: "150г", season: "всесезонно", type: "зелень", emoji: "🌿", badge: null, weight: "150г", weightKg: 0.15, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/8c6cf8f9-a9d6-4038-9a3c-cc61e94e3d9e.jpg" },
  { id: 502, name: "Укроп", price: 100, unit: "150г", season: "всесезонно", type: "зелень", emoji: "🌿", badge: null, weight: "150г", weightKg: 0.15, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/2f54a406-b6dd-4a99-9d42-ee3cf63e1a80.jpg" },
  { id: 503, name: "Петрушка", price: 100, unit: "150г", season: "всесезонно", type: "зелень", emoji: "🌿", badge: null, weight: "150г", weightKg: 0.15, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/5e3cd0ab-b9e3-4b7c-afb5-f9e3e71e3ab6.jpg" },
  { id: 504, name: "Редиска", price: 200, unit: "кг", season: "лето", type: "зелень", emoji: "🌰", badge: null, weight: "1кг", weightKg: 1, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/a1b7f9f4-7c44-4b7a-b9b1-df0bbf5e3a62.jpg" },
];
export const GREEN_TYPES = ["все", "зелень"];
...
export const EGG_TYPES = ["все", "яйца"];
...
export const MEAT_TYPES = ["все", "свинина"];

export const DAIRY = [
  { id: 809, name: "Молоко свежее коровье 4,2%", price: 100, unit: "л", season: "всесезонно", type: "молоко", emoji: "🐄", badge: "Хит", weight: "от 1,5 л", weightKg: 1.5, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/ec19e63b-3fa3-47b7-b893-c3ceac7b00fa.jpeg" },
  ...
  { id: 805, name: "Масло сливочное крестьянское 72,5% 200 г", price: 0, unit: "уп", season: "всесезонно", type: "масло", emoji: "🧈", badge: null, weight: "200 г", weightKg: 0.2, image: "https://cdn.poehali.dev/projects/7e63b123-cce1-42dc-b476-af41b89879ce/bucket/bf01c68d-3fcf-48b9-a646-7ff8f96915a1.jpg" },
...
export const DAIRY_TYPES = ["все", "молоко", "кисломолочное", "творог", "масло", "сыр"];
...
export const SAUSAGE_TYPES = ["все", "варёная", "копчёная", "сосиски", "ветчина"];
...
export const HOUSEHOLD_TYPES = ["все", "стирка", "салфетки", "бумага", "сад"];
...
export const GROCERY_TYPES = ["все", "мука", "крупы", "соусы", "чай", "консервы"];

export const READYFOOD = [
...
export const READYFOOD_TYPES = ["все", "салаты", "соленья", "снэки", "сладости"];

export const PRODUCTS = [...VEGETABLES, ...FRUITS, ...BERRIES, ...JUICES, ...MUSHROOMS, ...GREENS, ...EGGS, ...MEAT, ...DAIRY, ...SAUSAGE, ...HOUSEHOLD, ...GROCERY, ...READYFOOD];
...
export const TIPS = [
  { id: 1, emoji: "🥕", title: "Как выбрать свежую морковь", tag: "Выбор продуктов", text: "Свежая морковь должна быть твёрдой, без трещин и мягких пятен. Яркий оранжевый цвет говорит о высоком содержании бета-каротина. Хвостик должен быть зелёным, а не засохшим — это признак недавней уборки." },
  { id: 2, emoji: "🍅", title: "Помидоры: как хранить правильно", tag: "Хранение", text: "Никогда не кладите помидоры в холодильник — холод разрушает вкус и аромат. Храните при комнатной температуре подальше от прямых солнечных лучей. Спелые томаты лучше съесть в течение 2–3 дней." },
  { id: 3, emoji: "🥦", title: "Почему стоит есть сезонные овощи", tag: "Польза", text: "Сезонные овощи содержат в 2–3 раза больше витаминов, чем выращенные в теплице зимой. Они не проходят долгую транспортировку и не обрабатываются консервантами. Плюс — они значительно вкуснее и дешевле." },
  { id: 4, emoji: "🧅", title: "Лук: польза для иммунитета", tag: "Польза", text: "Лук содержит кверцетин — мощный антиоксидант, который укрепляет иммунитет и борется с воспалениями. Особенно полезен в сыром виде. Добавляйте в салаты, маринады и закуски для максимальной пользы." },
  { id: 5, emoji: "🥒", title: "Огурцы: освежают и очищают", tag: "Польза", text: "Огурцы на 95% состоят из воды и отлично утоляют жажду в жаркий день. Они содержат калий, который полезен для сердца, и клетчатку для нормальной работы кишечника. Лучше есть со шкуркой — в ней больше всего питательных веществ." },
  { id: 6, emoji: "🥔", title: "Картофель: как варить с пользой", tag: "Приготовление", text: "Варите картофель в мундире — так сохраняется максимум витамина C и калия. Не оставляйте очищенный картофель в воде надолго: витамины вымываются. Молодой картофель особенно полезен — в нём много антиоксидантов." },
];

export const NAV_LINKS = ["Каталог", "Доставка", "О сервисе", "Советы", "Отзывы", "FAQ", "Контакты"];