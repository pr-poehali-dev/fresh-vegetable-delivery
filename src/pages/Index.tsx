...
const REVIEWS = [
  ...
  { id: 2, name: "Михаил Р.", text: "Отличный сервис! Фильтр по сезонности помог найти именно то, что сейчас вкуснее всего. Доставка по предзаказу — очень удобно!", rating: 5, avatar: "👨‍💼", location: "Санкт-Петербург" },
